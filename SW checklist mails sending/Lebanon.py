...
def send_email(filepath_in):
    ...
    to_reciver = ['jawadzain@gmail.com', 'mengxiong.zhou@carlcare.com']  # 接收邮件，Lebanon.py可设置为你的QQ邮箱或者其他邮箱
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Lebanon">
    ...
    '''
    subject = 'Lebanon latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Lebanon.jpg", "Lebanon"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Lebanon')
