...
def send_email(filepath_in):
    ...
    to_reciver = ['qizhi.li@carlcare.com', 'hamed.hejrani@carlcare.com', 'hotline.ir@carlcare.com',
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Iran')
