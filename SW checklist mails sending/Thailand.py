...
def send_email(filepath_in):
    ...
    to_reciver = ['num_glico@hotmail.com', 'suwatsatayapukdeewong@gmail.com', 'repair.th@carlcare.com',
                  'bumtriplea@gmail.com', 'yanling.gong@carlcare.com', 'mengxiong.zhou@carlcare.com',
                  'rungrudee.infinix@gmail.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_reciver = ['tom.gao@carlcare.com', 'hoowanon@hotmail.com', 'boontharik.tai@gmail.com',
                  'mingxiong.hao@carlcare.com', 'montha.n@infinixmobility.com', 'fuping.zhu@carlcare.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Thailand">
    ...
    '''
    subject = 'Thailand latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Thailand.jpg", "Thailand"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Thailand')
