...
def send_email(filepath_in):
    ...
    to_reciver = ['angelina_maystrenko@f1center.ua', 'Oleg_Sinelnikov@f1center.ua',
                  'Andrey_Ivanchenko@f1center.ua', 'mengxiong.zhou@carlcare.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Ukraine">
    ...
    '''
    subject = 'Ukraine latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Ukraine.jpg", "Ukraine"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Ukraine')
