...
def send_email(filepath_in):
    ...
    to_reciver = ['mshawish@almawaredcomm.com', 'ahmad@almawaredcomm.com', 'lewa@almawaredcomm.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Jordan">
    ...
    '''
    subject = 'Jordan latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Jordan.jpg", "Jordan"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Jordan')
