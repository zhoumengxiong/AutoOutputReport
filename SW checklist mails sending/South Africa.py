...
def send_email(filepath_in):
    ...
    to_reciver = ['satish@mymobileza.com', 'dustin@mymobileza.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:South_Africa">
    ...
    '''
    subject = 'South Africa latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\South Africa.jpg", "South_Africa"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\South Africa')
