...
def send_email(filepath_in):
    ...
    to_reciver = ['jperis@axiomtelecom.com', 'santhosh.vayakara@axiomtelecom.com', 'najeeb@axiomtelecom.com',
                  'tharik@axiomtelecom.com', 'vysakh.raju@axiomtelecom.com',
                  'mengxiong.zhou@carlcare.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_reciver = ['barry.gao@carlcare.com', 'Khurshid.Alam@carlcare.com', 'mingxiong.hao@carlcare.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:UAE">
    ...
    '''
    subject = 'UAE latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\UAE.jpg", "UAE"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\UAE')
