...
def send_email(filepath_in):
    ...
    to_reciver = ['jing.wu@carlcare.com', 'mengxiong.zhou@carlcare.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_reciver = ['mingxiong.hao@carlcare.com', 'fuping.zhu@carlcare.com', 'miao.ji@carlcare.com',
                  'liang.xu@carlcare.com', 'wei.deng@carlcare.com', 'bo.wang@carlcare.com', 'yinling.chen@carlcare.com']
    ...
    '''
    subject = 'New market S/W check list_' + getNowDate() + ' integration'
...
if __name__ == '__main__':
    send_email(r"F:\Transsion\New market\New market SW checklist summary")
