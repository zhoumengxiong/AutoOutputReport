...
def write_repair_rate(value1):
    ...
    # 合并单元格样式设置
    cells = [
        'A20:A23', 'A25:A37', 'B20:C20', 'B21:C21', 'B22:C22', 'B23:C23',
        'B25:C25', 'B36:B37', 'P39:R39', 'B26:B30', 'B31:B35'
    ]
    ...
    for area in cells:
        style_range(
            ws, area, border=border, fill=None, font=font, alignment=al)
...
path = r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 KA7 repair rate(warranty)1.xlsx"
