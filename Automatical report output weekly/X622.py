...
model = "X622"
countries = {'Kenya': '肯尼亚', 'Indonesia': '印度尼西亚', 'Uganda': '乌干达', 'Egypt': '埃及', 'Nigeria': '尼日利亚',
             'Pakistan': '巴基斯坦'}
# 备用
...
path = r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 X622 repair rate(warranty)1.xlsx"
