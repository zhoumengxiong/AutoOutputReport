...
model = "X5515"
countries = {'Uganda': '乌干达', 'Kenya': '肯尼亚', 'Pakistan': '巴基斯坦', 'Cote dIvoire': '科特迪瓦', 'Ghana': '加纳',
             'Nigeria': '尼日利亚', 'Tanzania': '坦桑尼亚', 'Egypt': '埃及', 'Zambia': '赞比亚', 'Indonesia':
                 '印度尼西亚', 'Morocco': '摩洛哥'}
config = {
...
path = r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 X5515 repair rate(warranty)1.xlsx"
