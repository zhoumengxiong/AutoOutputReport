...
model = "F1"
countries = {'Kenya': '肯尼亚', 'Cote dIvoire':
    '科特迪瓦', 'Mali': '马里', 'Tanzania': '坦桑尼亚', 'Senegal': '塞内加尔', 'Uganda': '乌干达',
             'Rwanda': '卢旺达', 'Niger': '尼日尔', 'Cameroon': '喀麦隆', 'Zambia': '赞比亚', 'Nigeria': '尼日利亚'}
...
config = {
    ...
    'password': "Dream123$",  # 以及数据库密码ythonI_project/repair_report output/F1.py"
...
path = r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 F1 repair rate(warranty)1.xlsx"
