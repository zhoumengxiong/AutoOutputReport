...
model = "P32"
countries = {'Nigeria': '尼日利亚', 'Senegal': '塞内加尔', 'Tanzania': '坦桑尼亚', 'Cote dIvoire':
    '科特迪瓦', 'Zambia': '赞比亚', 'Ghana': '加纳', 'Kenya': '肯尼亚', 'Mali': '马里', 'Vietnam': '越南', 'Cameroon':
                 '喀麦隆', 'Bangladesh': '孟加拉', 'Morocco': '摩洛哥'}
config = {
...
path = r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 P32 repair rate(warranty)1.xlsx"
