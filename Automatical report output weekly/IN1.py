...
wb = load_workbook(
    r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 IN1 repair rate(warranty)1.xlsx")
for key, value in countries.items():
    fillsheet(key, value)
wb.save(
    filename=r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 IN1 repair rate(warranty)1.xlsx")
