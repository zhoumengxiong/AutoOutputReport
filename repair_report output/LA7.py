...
model = "LA7"
countries = {'Nigeria': '尼日利亚', 'Senegal': '塞内加尔', 'Tanzania': '坦桑尼亚', 'Uganda': '乌干达',
             'Cote dIvoire': '科特迪瓦', 'Kenya': '肯尼亚', 'Mali': '马里', 'Ghana': '加纳', 'Niger': '尼日尔',
             'Cameroon': '喀麦隆'}
config = {
...
path = r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 LA7 repair rate(warranty)1.xlsx"
