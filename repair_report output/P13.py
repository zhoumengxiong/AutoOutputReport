...
model = "P13"
countries = {'Nigeria': '尼日利亚', 'Uganda': '乌干达', 'Cote dIvoire': '科特迪瓦', 'Ghana': '加纳', 'Tanzania': '坦桑尼亚',
             'Senegal': '塞内加尔', 'Zambia': '赞比亚', 'Kenya': '肯尼亚', 'Mali': '马里', 'Cameroon':
                 '喀麦隆'}
# 预留国家
"""{'Nigeria': '尼日利亚', 'Senegal': '塞内加尔', 'Tanzania': '坦桑尼亚', 'Uganda': '乌干达', 'Cote dIvoire':
...
path = r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 P13 repair rate(warranty)1.xlsx"
