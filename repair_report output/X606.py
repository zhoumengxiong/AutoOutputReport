...
model = "X606"
countries = {'Nigeria': '尼日利亚', 'Uganda': '乌干达', 'Kenya': '肯尼亚', 'Zambia': '赞比亚', 'Tanzania': '坦桑尼亚',
             'Cote dIvoire': '科特迪瓦', 'Benin': '贝宁', 'Ghana': '加纳', 'Rwanda': '卢旺达', 'Egypt': '埃及',
             'Morocco': '摩洛哥'}
config = {
...
path = r"F:\Transsion\Repair rate report\repair_rate_report\transition\week23 X606 repair rate(warranty)1.xlsx"
