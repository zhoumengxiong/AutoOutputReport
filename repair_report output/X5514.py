...
model = "X5514"
countries = {'Nigeria': '尼日利亚', 'Egypt': '埃及', 'Zambia': '赞比亚', 'Tanzania': '坦桑尼亚', 'Kenya': '肯尼亚',
             'Benin': '贝宁', 'Morocco': '摩洛哥', 'Ghana': '加纳', 'Bangladesh': '孟加拉'}
# 预备国家
...
path = r"/mnt/hgfs/Transsion/Repair rate report/repair_rate_report/transition/week23 X5514 repair rate(warranty)1.xlsx"
