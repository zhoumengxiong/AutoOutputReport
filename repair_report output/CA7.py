...
# 计算当前周所在的列号
col = getNowYearWeek()[1] - 1 - 10
model = "CA7"
countries = {'Nigeria': '尼日利亚', 'Mali': '马里', 'Ghana': '加纳', 'Senegal': '塞内加尔', 'Tanzania': '坦桑尼亚',
             'Uganda': '乌干达', 'Cote dIvoire': '科特迪瓦', 'Kenya': '肯尼亚', 'Cameroon': '喀麦隆', 'Egypt': '埃及'}
config = {
...
wb = load_workbook(r"C:\Users\Dream\week23 CA7 repair rate(warranty)1.xlsx")
for key, value in countries.items():
    fillsheet(key, value)
wb.save(filename=r"C:\Users\Dream\week23 CA7 repair rate(warranty)1.xlsx")
