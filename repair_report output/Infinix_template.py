...
model = "X573"
countries = {'Nigeria': '尼日利亚', 'Tanzania': '坦桑尼亚', 'Cote dIvoire': '科特迪瓦',
             'Egypt': '埃及', 'Ghana': '加纳', 'Pakistan': '巴基斯坦', 'Morocco': '摩洛哥', 'Indonesia': '印度尼西亚',
             'India': '印度'}
config = {
...
path = r"F:\Transsion\Repair rate report\repair_rate_report\transition\week23 X573 repair rate(warranty)1.xlsx"
