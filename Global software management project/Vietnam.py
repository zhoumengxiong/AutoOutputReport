...
def send_email(filepath_in):
    ...
    to_reciver = ['hung.nguyen@vietcomindo.com', 'tin.tang@carlcare.com',
                  'mengxiong.zhou@carlcare.com', 'shawn.tian@carlcare.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_reciver = ['tom.gao@carlcare.com', 'dylan.liang@carlcare.com', 'duy.nguyen@carlcare.com',
                  'ha.vu@vietcomindo.com', 'kevin.zhao@carlcare.com', 'mingxiong.hao@carlcare.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Vietnam">
    ...
    '''
    subject = 'Vietnam latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Vietnam.jpg", "Vietnam"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Vietnam')
