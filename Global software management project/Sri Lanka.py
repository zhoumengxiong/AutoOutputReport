...
def send_email(filepath_in):
    ...
    to_reciver = ['vasanth.kumar@transsion.com', 'mengxiong.zhou@carlcare.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_reciver = ['tom.gao@carlcare.com', 'kevin.zhao@carlcare.com', 'fuping.zhu@carlcare.com',
                  'sanjana.k@transsion.com', 'kundan.kumar@transsion.com', 'mingxiong.hao@carlcare.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Srilanka">
    ...
    '''
    subject = 'Sri Lanka latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Sri Lanka.jpg", "Srilanka"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Sri Lanka')
