...
def send_email(filepath_in):
    ...
    to_reciver = ['alpinecomsb@gmail.com', 'maggie_tan@ixsun.com.my', 'aaron_teng@ixsun.com.my', 'farah.cny@gmail.com',
                  'calvenchean@gmail.com', 'mengxiong.zhou@carlcare.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_reciver = ['tom.gao@carlcare.com', 'stephen.liu@infinixmobility.com', 'mingxiong.hao@carlcare.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Malaysia">
    ...
    '''
    subject = 'Malaysia latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Malaysia.jpg", "Malaysia"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Malaysia')
