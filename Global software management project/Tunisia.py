...
def send_email(filepath_in):
    ...
    to_reciver = ['makram.jarraya@retech.tn', 'support@retech.tn', 'service@retech.tn',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Tunisia">
    ...
    '''
    subject = 'Tunisia latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Tunisia.jpg", "Tunisia"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Tunisia')
