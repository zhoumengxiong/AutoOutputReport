...
def send_email(filepath_in):
    ...
    to_reciver = ['nadia.joua@cetelec.ma', 'feng.cheng@carlcare.com', 'kabbajsystem.sav.fes@gmail.com',
                  'saad.zerrad@carlcare.com', 'mengxiong.zhou@carlcare.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_reciver = ['keshuang.deng@transsion.com', 'mingxiong.hao@carlcare.com', 'fuping.zhu@carlcare.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Morocco">
    ...
    '''
    subject = 'Morocco latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Morocco.jpg", "Morocco"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Morocco')
