...
def send_email(filepath_in):
    ...
    to_reciver = ['said.f@carlcare.com', 'ahmad.faisal@carlcare.com', 'fakih.ardiansyah@m-care.co.id',
                  'mengxiong.zhou@carlcare.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_reciver = ['tom.gao@carlcare.com', 'jun.ma@carlcare.com', 'mingxiong.hao@carlcare.com',
                  'fuping.zhu@carlcare.com', 'miao.ji@carlcare.com',
                  'dony.xiang@carlcare.com']
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Indonesia">
    ...
    '''
    subject = 'Indonesia latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Indonesia.jpg", "Indonesia"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Indonesia')
