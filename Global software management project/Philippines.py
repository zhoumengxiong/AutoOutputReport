...
def send_email(filepath_in):
    ...
    to_reciver = ['jma@citylight.com.ph', 'service.ph@carlcare.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Philippines">
    ...
    '''
    subject = 'Philippines latest version software check list_week' + str(wk)
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Philippines.jpg", "Philippines"))
...
if __name__ == '__main__':
    send_email(r'F:\Transsion\New market\latest version software checklist by country\Philippines')
