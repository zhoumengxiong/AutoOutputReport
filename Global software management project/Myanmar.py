...
def send_email(filepath_in):
    ...
    to_reciver = ['htet.htun@carlcare.com', 'mengxiong.zhou@carlcare.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    cc_reciver = ['tom.gao@carlcare.com', 'tim.liao@carlcare.com', 'kevin.zhao@carlcare.com',
    ...
    <hr />
    <p><b><i>Newly added or updated items are marked with red.</i></b></font><br /><img src="cid:Myanmar">
    ...
    if r is False:
        ...
        msg.attach(addimg(r"F:\Python在路上\PythonI_project\SW checklist images\Myanmar.jpg", "Myanmar"))
